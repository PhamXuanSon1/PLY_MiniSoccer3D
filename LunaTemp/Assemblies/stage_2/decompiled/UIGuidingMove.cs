...
public class UIGuidingMove : MonoBehaviour
{
	...
	[SerializeField]
	private Vector2 startPosition = new Vector2(-230f, 0f);

	[Tooltip("Vị trí kết thúc di chuyển (Anchored Position)")]
	[SerializeField]
	private Vector2 endPosition = new Vector2(290f, 0f);
	...
	[SerializeField]
	private bool resetToStartOnComplete = false;
	...
	public void PlaySequence()
	{
		...
		{
			moveTween = target.DOAnchorPos(endPosition, duration).SetEase(ease);
			if (loop)
			{

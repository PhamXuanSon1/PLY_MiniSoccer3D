...
if ( TRACE ) { TRACE( "GameManager#GotoStore", this ); }
                    ...
                    if (!(UnityEngine.Time.unscaledTime - GameManager.lastGotoStoreTime < 0.6)) {
                        GameManager.lastGotoStoreTime = UnityEngine.Time.unscaledTime;
...
if ( TRACE ) { TRACE( "RonaldoPenalty.PenaltyGameManager#EndGameEvaluationRoutine", this ); }
                        ...
                        for (;;) {
                            switch ($step) {
                                ...
                                case 2: {
                                    this.currentState = RonaldoPenalty.PenaltyGameState.Result;
                                        if (UnityEngine.MonoBehaviour.op_Inequality(this.ronaldoAnimator, null)) {
                                            this.ronaldoAnimator.PlayCelebrate();
                                        }
                                        AppLovinAnalytics.Track(ALEvent.CHALLENGE_SOLVED);
            ...
            /*RonaldoPenalty.PenaltyGameManager.EnableTapToStoreAfterDelay start.*/
            EnableTapToStoreAfterDelay: function (delay) {
if ( TRACE ) { TRACE( "RonaldoPenalty.PenaltyGameManager#EnableTapToStoreAfterDelay", this ); }
            ...
            /*RonaldoPenalty.PenaltyGameManager.EnableTapToStoreAfterDelay end.*/
...
if ( TRACE ) { TRACE( "RonaldoPenalty.PenaltyUIManager#ShowWinEndcard", this ); }
                ...
                this.ShowWinEndcard$1(this.winDelay, onClickStore);
            },
            /*RonaldoPenalty.PenaltyUIManager.ShowWinEndcard end.*/

            /*RonaldoPenalty.PenaltyUIManager.ShowWinEndcard$1 start.*/
            ShowWinEndcard$1: function (delay, onClickStore) {
if ( TRACE ) { TRACE( "RonaldoPenalty.PenaltyUIManager#ShowWinEndcard$1", this ); }
                ...
                this.SetObjectsActive(this.objectsToShowOnWin, true);
                UnityEngine.MonoBehaviour.op_Inequality(($t = Ply_SoundManager.Instance), null) ? $t.PlayFx(FxType.Confetti) : null;
                this.StartCoroutine$1(this.WinRoutine(delay, onClickStore));
            },
            /*RonaldoPenalty.PenaltyUIManager.ShowWinEndcard$1 end.*/

            /*RonaldoPenalty.PenaltyUIManager.WinRoutine start.*/
            WinRoutine: function (delay, onClickStore) {
if ( TRACE ) { TRACE( "RonaldoPenalty.PenaltyUIManager#WinRoutine", this ); }
            ...
            /*RonaldoPenalty.PenaltyUIManager.WinRoutine end.*/
...
if ( TRACE ) { TRACE( "RonaldoPenalty.PenaltyUIManager#OnClick_GotoStore", this ); }
        ...
        overloads: {
            "ShowWinEndcard(float, Action)": "ShowWinEndcard$1"
        }
    });
...
if ( TRACE ) { TRACE( "Ply_SoundManager#PlayFx", this ); }
                ...
                if ((data == null || data.clip == null) && fxType === FxType.Confetti) {
                    var allClips = UnityEngine.Resources.FindObjectsOfTypeAll(UnityEngine.AudioClip);
                    var array = allClips;
                    $t = Bridge.getEnumerator(array);
                    try {
                        while ($t.moveNext()) {
                            var c = $t.Current;
                            if (c != null && System.String.contains(c.name.toLowerCase(),"confetti")) {
                                if (data == null) {
                                    data = new SoundData();
                                    this.audioClips.Confetti = data;
                                }
                                data.clip = c;
                                break;
                            }
